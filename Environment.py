...
class Environment:
	...
	def draw_status(self, score, level):
		...
		levelRect.topleft = (self.width - 150, 110)
	...
	def draw_next_piece(self, piece):
		...
		# draw the "next" piece
		self.draw_piece(piece, pixelx=self.width-150, pixely=160)
...
def main():
	...
	while True:
		env.step()
		DISPLAYSURF.blit(env.DISPLAYSURF, (0,0))  # Blit environment surface onto main surface
		pygame.display.update()
